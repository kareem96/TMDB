...
import 'package:movie/presentation/bloc/review/review_bloc.dart';
import 'package:movie/presentation/bloc/top_rated/movie_top_rated_bloc.dart';
import 'package:movie/presentation/bloc/trailer/trailer_video_bloc.dart';
...
void init() {
  ...
  locator.registerFactory(() => TrailerVideoBloc(locator()));
  ...
  locator.registerLazySingleton(() => GetTrailerVideo(locator()));
